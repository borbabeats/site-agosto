...
import FotosAereaHome from '../../../Config/Images/Home/FotosAereaHome.jpg'
import imageFirst from '../../../Config/Images/Home/firstPhoto.jpg'
            ...
            <Row>
                <Col className="ml-auto mr-auto mt-3" md="15" lg="15" sm="15">
                    ...
                    <div className='d-flex text-center'>
                        <Fade>
                            <img src={imageFirst} alt="" style={{ height: '100%', width: '50%', borderRadius: 20, opacity: '0.9', background: 'rbga(0,0,0,0.8)', padding: 10 }} />
