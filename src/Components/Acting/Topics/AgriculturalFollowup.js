...
export default function AgriculturalFollowup({ id, ImgSegAgri }) {
        ...
        areas: [
            {
                ...
                img: [require('../../../Config/Images/ImagensTrator/Center Link.png')]
            }, {
                name: "2 - Eixo Longo",
                shape: 'poly',
                fillColor: fillColor,
                ...
                img: [require('../../../Config/Images/ImagensTrator/Rear Bar Axle.png')]
            }, {
                name: "3 - Eixo Longo",
                shape: 'poly',
                fillColor: fillColor,
                ...
                img: [require('../../../Config/Images/ImagensTrator/Stabilizer.png')]
            }, {
                ...
                img: [require('../../../Config/Images/ImagensTrator/Hook.png')]
            }, {
                name: "14 - Flange Yoke",
                shape: 'circle',
                fillColor: fillColor,
    ...
    const onMouseEnter = (area, ind, event) => {
        ...
        setDivPosition({ left: (clientX - left), top: (clientY - top) })
        SetInfoPiece(area);
        setIsVisible(true);
    }
